...
#'     directory accessing}
#'   \item{\code{\link{search_existing_models}}}{searches saved R-objects in the
#'     river directories.}
#' }
#'
...
#'     R-object.}
#'   \item{\code{\link{import_riverdata}}}{ reads all river data from a directory.}
#'   \item{\code{\link{build_model}}}{ is a small function handling model
#'     creation and invokes \code{\link[rstanarm]{stan_lm}} for model building.}
#'   \item{\code{\link{ask_for_variables}}}{asks the user which variables shall
#'     be included in the model. Creates plots as a side effect.}
#'   \item{\code{\link{process_model_riverdata}}}{processes a data.frame with
#'     the necessary data for the data argument in \code{\link[rstanarm]{stan_lm}}}
...
#' \describe{
#'   \item{\code{\link{predict_quality}}}{is the overhead function for the
#'     prediction. It also invokes \code{\link[rstanarm]{posterior_predict}}}
...
#'   \item{\code{\link{plot_data_overview}}}{plot data overview}
#'   \item{\code{\link{plot_hygiene_overview}}}{a statistical hygiene data overview}
#'   \item{\code{\link{plot_q_overview}}}{plot a overview of all q values}
#'   \item{\code{\link{plot_rain_overview}}}{ plot a monthly overview of all
#'     rain gauges}
#' }
#'
#' @docType package
